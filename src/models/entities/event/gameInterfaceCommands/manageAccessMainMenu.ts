...
export const EVENT_COMMAND_MANAGE_ACCESS_MAIN_MENU_VALIDATOR = z.object({
  type: z.literal('manage_access_main_menu'),
...
export type StudioEventCommandManageAccessMainMenu = z.infer<typeof EVENT_COMMAND_MANAGE_ACCESS_MAIN_MENU_VALIDATOR>;
