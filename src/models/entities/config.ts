...
const MUSICS_SOUNDS_CONFIG_VALIDATOR = z.object({
  klass: z.literal('Configs::Project::MusicsSounds'),
...
export type MusicsSoundsConfig = z.infer<typeof MUSICS_SOUNDS_CONFIG_VALIDATOR>;
