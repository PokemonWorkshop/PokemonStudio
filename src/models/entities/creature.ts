...
export const CREATURE_FORM_VALIDATOR = z.object({
  form: POSITIVE_OR_ZERO_INT,
  height: POSITIVE_OR_ZERO_FLOAT,
  weight: POSITIVE_OR_ZERO_FLOAT,
  type1: DB_SYMBOL_VALIDATOR,
  type2: DB_SYMBOL_VALIDATOR,
  baseHp: POSITIVE_INT,
  baseAtk: POSITIVE_INT,
  baseDfe: POSITIVE_INT,
  baseSpd: POSITIVE_INT,
  baseAts: POSITIVE_INT,
  baseDfs: POSITIVE_INT,
  evHp: POSITIVE_OR_ZERO_INT,
  evAtk: POSITIVE_OR_ZERO_INT,
  evDfe: POSITIVE_OR_ZERO_INT,
  evSpd: POSITIVE_OR_ZERO_INT,
  evAts: POSITIVE_OR_ZERO_INT,
  evDfs: POSITIVE_OR_ZERO_INT,
  ...
  femaleRate: z.union([POSITIVE_OR_ZERO_INT, z.literal(-1)]),
