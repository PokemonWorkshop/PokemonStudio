...
import { FilenameWithData, readProjectFolder } from './readProjectData';
...
export type ReadMapsOutput = { maps: FilenameWithData[]; mapInfo: string; mapNames: string[][]; mapDescriptions: string[][] };
