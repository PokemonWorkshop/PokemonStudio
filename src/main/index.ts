...
import {
  ...
  registerGetEntityTextInProjectStateTask,
  registerGetTextColumnInProjectState,
  registerGetTextInProjectState,
...
} from '@src/projectState/backendTasks';
...
registerLoadProjectStateTask(ipcMain);
registerGetEntityInProjectStateTask(ipcMain);
registerSetEntityInProjectStateTask(ipcMain);
registerGetTextKeysInProjectStateTask(ipcMain);
registerGetEntityListInProjectStateTask(ipcMain);
