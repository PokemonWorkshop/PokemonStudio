...
const getMapOptions = (defaultMapOptions: OldSelectOption[], mapLink: StudioMapLink, maps: ProjectData['maps']): SelectOption<string>[] => {
  const mapOptions = mapLinkMapOptions(defaultMapOptions, maps);
...
export const MapLinkAddMapEditor = forwardRef<EditorHandlingClose, MapLinkAddMapEditorProps>(({ closeDialog, cardinal }, ref) => {
  ...
  const mapOptions = useMemo(() => getMapOptions(defaultMapOptions, mapLink, maps), [defaultMapOptions, mapLink, maps]);
