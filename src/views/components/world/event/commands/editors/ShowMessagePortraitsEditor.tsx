...
type ShowMessagePortraitsEditorProps = { closeDialog: () => void } & EventEditorProps;

export const ShowMessagePortraitsEditor = forwardRef<EditorHandlingClose, ShowMessagePortraitsEditorProps>(
  ({ commandId: defaultCommandId, event, closeDialog }, ref) => {
