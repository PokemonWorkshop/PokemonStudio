...
import { SelectPokemon, SelectPokemon2 } from '@components/selects/SelectPokemon';
...
export const QuestEarningPokemonV2 = ({ earning, earningCreature }: QuestEarningPokemonProps) => {
